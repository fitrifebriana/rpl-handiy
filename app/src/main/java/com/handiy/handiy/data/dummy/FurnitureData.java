...
public class FurnitureData {
    ...
    private static final int[] img = {R.drawable.dummy_img3, R.drawable.dummy_img3,
            R.drawable.dummy_img3,R.drawable.dummy_img3,R.drawable.dummy_img3,R.drawable.dummy_img3};
