...
public class DecorationData {
    ...
    private static final int[] img = {R.drawable.dummy_img2, R.drawable.dummy_img2,
            R.drawable.dummy_img2,R.drawable.dummy_img2,R.drawable.dummy_img2,R.drawable.dummy_img2};
